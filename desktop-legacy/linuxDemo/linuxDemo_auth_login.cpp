// linuxDemo_auth_login.cpp (Demo Mode)
#include <algorithm>
#include <cctype>
#include <cstring>
#include <iostream>
...
// On Linux, just use extern "C" without __declspec(dllexport)
extern "C" int validate_login(const char *username, const char *password) {
...
extern "C" int register_user(const char *first_name, const char *last_name,
                             const char *street_address, const char *city,
                             const char *state, const char *zip_code,
