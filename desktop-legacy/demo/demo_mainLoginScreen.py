...
from demo_registerUI import RegisterScreen
...
class LoginScreen(QWidget):
    # Handle Escape key press to confirm exit
    ...
    # Validate login credentials using DLL
    ...
    def __init__(self):
        ...
        dll_path = os.path.abspath(
            os.path.join(os.path.dirname(__file__), "demo_auth_login.dll")
        )
