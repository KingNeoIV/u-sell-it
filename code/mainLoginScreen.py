...
from registerUI import RegisterScreen        # Imports your custom registration screen class
...
class LoginScreen(QWidget):                                                             # Define a custom LoginScreen class that inherits QWidget to function as the main login window
    ...
    def __init__(self):                                                         # Constructor method that initializes the LoginScreen object and sets up its starting state
        ...
        dll_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "auth_login.dll"))       # Resolve the absolute path to the auth_login.dll for dynamic loading in the login workflow
